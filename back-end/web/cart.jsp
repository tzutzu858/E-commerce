...
<div class="wrapper">
    ...
    <form action="controller" method="post">
        <div class="container">
            <div class="row order_list center-vertical app_display_none">
            ...
            <div class="goods">
                <c:forEach var="row" items="${cart}">
                    <div class="row order_list ">
                        <div class="order_goods_name web_display_none app_goodsname">${row.goodsname}</div>
                        <div class="col-5 center-vertical justify-content-start goodsname_img_block">
                            <img class="order_goods_img" src="img/${row.goodsimg}"/>
                            <div class="order_goods_name app_display_none">${row.goodsname}</div>
                        </div>
                        <div class="col center-vertical">
                            <span class="web_display_none">單價 : </span>
                        ...
                        <div class="col center-vertical">
                            <div class="center-vertical amount">
                                ...
                                <input class="order_amount" name="quantity_${row.goodsid}"
                                       onblur="calc(${row.goodsid}, this)" value="${row.quantity}"
                                       readonly="readonly"/>
                                <button class="amount_btn add_btn" type="button">+</button>
                            </div>
                        </div>
                        <div class="col center-vertical">
                            <span class="web_display_none">總計 : </span>
                            <span class="order_price_total"
                                  id="subtotal_${row.goodsid}">${row.price * row.quantity}</span>
                        </div>
                        <div class="col center-vertical">
                            <button class="del_btn" type="button" data-toggle="modal" data-target="#staticBackdrop">
                                刪除
                            </button>
